        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<?php echo url('banners/update'); ?>?id=<?php echo $banner['id']; ?>"  method="post" class="form-horizontal" enctype="multipart/form-data" >
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">外链地址:</label>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="https://www.baidu.com" class="form-control" name="links" value="<?php echo $banner['links']; ?>"><p>外链地址,不外链填＃</p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <img src="<?php echo $banner['img']; ?>" width="109px" height="109px" alt="" id="addMain" >
                                    ...
                                    <input type="hidden" name="img" value="<?php echo $banner['img']; ?>" id="bannerImg">
