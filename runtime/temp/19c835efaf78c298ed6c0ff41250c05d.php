                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="footable table table-stripped" data-page-size="10" data-filter=#filter>
                            ...
                            <tr class="gradeX">
                                <td><?php echo $v['id']; ?></td>
                                <td><img class="img1" style="width:80px;display: block; " alt="image" src="<?php echo $v['img']; ?>" /></td>
                                <td><?php echo $v['links']; ?></td>
                                <td><?php echo $v['sort']; ?></td>
                                <td><?php echo $v['created_at']; ?></td>
                                <td>
                                    <a href="<?php echo url('banners/edit'); ?>?id=<?php echo $v['id']; ?>">修改</a>  | <a onclick="delBanner('<?php echo $v['id']; ?>')">删除</a></td>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
